...
- First, see the section on the _[Scream Discard](level-7.mdx#the-scream-discard-chop-move-sdcm)_ and the _[Generation Discard](level-6.mdx#the-generation-discard)_.
